...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tips:Array<Tip> = arrayOf(
            Tip(
                "1 Duis meu mi, tristique sit amet dolor sit",
        ...
        view_pager.setPageTransformer(true) { page: View, position: Float ->
        ...
        back.setOnClickListener{
            Toast.makeText(this, "Ir para a Home", Toast.LENGTH_SHORT).show()
        }
